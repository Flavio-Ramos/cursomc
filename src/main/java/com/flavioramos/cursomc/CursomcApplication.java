...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto caderno = new Produto(null, "Caderno", 35.00);
		Produto caneta = new Produto(null, "Caneta", 3.00);
		Produto guitarra = new Produto(null, "Guitarra", 2500.00);
		Produto bateria = new Produto(null, "Bateria", 5200.00);
		Produto vassoura = new Produto(null, "Vassoura", 15.00);
		Produto sabao = new Produto(null, "Sabão", 7.00);
		Produto teclado = new Produto(null, "Teclado", 350.00);
		Produto bola = new Produto(null, "Bola", 95.00);
		Produto redeDeVolei = new Produto(null, "Rede de Volêi", 74.00);
		...
		categoriaRepository.saveAll(Arrays.asList(informatca, Esritorio,musica,esportes,limpeza,escola));
		produtoRepository.saveAll(Arrays.asList(computador, impressora, mouser,caderno,caneta,guitarra,bateria,vassoura,sabao,teclado,bola,redeDeVolei));
